			 ...
			 <li class="nav-item">
              <a href="profile.php" class="nav-link">
                <span class="text-success nav-link-inner--text font-weight-bold"
                  ><i class="text-success fas fa-user-circle"></i> <?php echo $tname ?></span
                >
              </a>
            </li>
            ...
            <div class="offset-md-4 col-md-4 mb-3">
                ...
                <div class="card-body bg-gradient-info">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="../assets/img/teacher.jpg" alt="student" class="rounded-circle" width="177">
                    <div class="mt-3">
                      <h4>                      <?php echo $tname ?></h4>
                      <p class="text-white mb-1"> <?php echo $tusername ?> </p>
