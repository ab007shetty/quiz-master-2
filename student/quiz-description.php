...
<div class="row">
            ...
            <span class="badge badge-danger badge-pill mb-3">Take Quiz</span>
...
?>
        ...
        if($result-> num_rows > 0) {
            ...
            <p>TITLE</p>
            <input type="text" class="form-control font-weight-bold" disabled value="<?php echo $row['quizName']?>">
            <p>INSTRUCTOR</p>
            <input type="text" class="form-control font-weight-bold" disabled value="<?php echo $row['name']?>">
            <p>START TIME</p>
            <input type="text" class="form-control font-weight-bold" disabled value="<?php echo $row['dateOpen']?>">
            <p>END TIME</p>
            <input type="text" class="form-control font-weight-bold" disabled value="<?php echo $row['dateClose']?>">
            <?php }
        } ?>
        </div>
        <div > 
        <a href="quiz.php?quizcode=<?php echo $code?>"><button name="submit" class="mt-3 btn btn-success">Go</button></a>
        </div>
