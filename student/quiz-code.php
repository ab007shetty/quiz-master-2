...
<div class="row">
            ...
            <span class="badge badge-danger badge-pill mb-3">Take any Quiz</span>
					  ...
					  <form action="findQuiz.php" method="GET">
            <?php 
                ...
                <div class="row col-md-12 text-center">
                    <input type="text" class="form-control" name="code" placeholder="ENTER QUIZ CODE" required>
				 </div>	
					
					 <div class="mt-3">  
                    <a href="home.php"><input value="Cancel" class="col-4 form-control btn btn-danger btn4"></a>
                    <input type="submit" name="submit" value="Go " class=" col-7  form-control btn btn-success btn3">
                </div>
