...
<div class="row">
            ...
            <span class="badge badge-danger badge-pill mb-3">Result</span>
        ...
        if($result-> num_rows > 0) {
            ...
            <p>MARK</p>
            <input type="text"  class="form-control font-weight-bold" disabled value="<?php echo $row['mark']?>%">
            <?php }
        } ?>
        </div>
        <a href="scorecard.php"><button name="submit" class="mt-3 btn btn-info">Next</button></a>
