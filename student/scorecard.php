        ...
        $res = mysqli_query($conn, $quiz);
            ...
            if($res)
            {
                ...
                while ($row = mysqli_fetch_assoc($res)) {                
                    echo "<tr  class=\" text-center text-dark\"><td>".$row["answeredQuizID"]."</td><td>".$row["quizName"]."</td><td>".$row["dateOpen"]."</td><td>".$row["dateClose"]."</td><td>".$row["mark"]."</tr>"; 
                }
                echo "</table></div>";
            }
            else{
